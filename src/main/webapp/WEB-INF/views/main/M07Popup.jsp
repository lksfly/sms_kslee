	...
	<div id="M05Modal-content" class="modal-content modal-s" style="max-height: 70% !important;">
		<div class="card body-scroll" style="height: 100%;">
			<div class="card-header title-row">
				<h1 class="content-title2">지역별 지원건수 현황</h1>
...
<!-- end:: modal-s small모달-->
		...
		<script type="text/javascript">
			...
			function searchData() {
				$.get(CONTEXT_PATH + '/main/dashboard/api/M07', {
			...
			function content_dataTable(dataList) {
				...
				var columns = [
					...
					{ data: 'RGN_NM',  className: 'dt-body-center', orderable: true }, // [1] 지역명(시/도)
					{ data: 'GIVE_CNT',className: 'dt-body-right',  orderable: true }, // [2] 지원건수
				];
				var columnDefs = [{
